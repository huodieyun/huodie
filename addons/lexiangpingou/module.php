 ...
 *
 * @author 甜筒君
 * @url http://bbs.lexiangpingou.cn/
 */
defined('IN_IA') or exit('Access Denied');
define('MB_ROOT', IA_ROOT . '/addons/lexiangpingou');
define('MB2_ROOT', IA_ROOT . '/attachment/lexiangpingou');
class lexiangpingouModule extends WeModule {
	public function settingsDisplay($settings) {
		global $_W, $_GPC, $frames;
		require_once MB_ROOT . '/source/backlist.class.php';
        $backlist = new backlist();
		$frames = $backlist->getModuleFrames('lexiangpingou');
