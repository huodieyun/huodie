...
define('TG_NAME', 'lexiangpingou');

!defined('TG_PATH') && define('TG_PATH', IA_ROOT . '/addons/lexiangpingou/');
...
!defined('TG_URL') && define('TG_URL', '//'.$_SERVER['HTTP_HOST'] . '/addons/lexiangpingou/');
