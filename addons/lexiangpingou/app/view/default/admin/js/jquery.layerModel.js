...
; (function($) {
	...
	var methods = {
		...
		init: function(data, options) {
			var defaults = {
				center: true,locked: true,fixed: true,drag: true,zIndex: 9999,opacity: "0.5",title: "请选择订单",staySame: false,isLoading : false,width: 0,height: 0,timer: 0,bgColor: "#e5dfda",left: 350,top: 100,head: true,isClose: true,shake: false,blurClose: false,close: null,init: null
			};
