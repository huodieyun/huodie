 ...
 */
	...
	if(!empty($_GPC['orderno'])){
		$order = pdo_fetch("select * from ".tablename('tg_function_order')." where orderno='{$_GPC['orderno']}'");
	...
	$funclist=pdo_fetch("select * from ".tablename('tg_function')." where id=:id",array(':id'=>$order['functionid']));
	$params['tid'] = $_GPC['orderno'];
	$params['user'] = $_W['fans']['from_user'];
	$params['fee'] = $order['price'];
	$params['title'] = $funclist['name'];
