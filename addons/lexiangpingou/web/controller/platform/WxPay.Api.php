<?php
require_once MODULE_ROOT . "/web/controller/platform/WxPay.Exception.php";
require_once MODULE_ROOT . "/web/controller/platform/WxPay.Config.php";
require_once MODULE_ROOT . "/web/controller/platform/WxPay.Data.php";
