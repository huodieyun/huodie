...
if ($do == 'group') {
	...
	include wl_template('member/activity/coupon_group_list');
}
...
//		wl_debug($tg_coupon_template_data);
		...
		message('编辑成功', web_url('member/coupon/edit', array('id' => $id)), 'success');
	}
	
	
	
	include wl_template('member/activity/coupon_group_edit');
}
