...
//      $ifrefund = setting_get_by_name('refund');
        ...
        $pay['appid'] = $account['key'];
        $pay['mchid'] = $ifrefund['mchid'];
        $pay['key'] = $ifrefund['apikey'];
        $pay['appsecret'] = $account['secret'];
        return $pay;
    }
	//=======【基本信息设置】=====================================
	//
	 ...
	 * @var string
	 */
//	const APPID = 'wx866e0a731d303c29';
//	const MCHID = '1249906301';
//	const KEY = 'guyhtoiggvyqrow5imuzd25ubgwjqmhk';
//	const APPSECRET = '3767bbbb44f6bf22afebe2452f1dac2b';
