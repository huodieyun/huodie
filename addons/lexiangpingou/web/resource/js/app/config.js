require.config({
	baseUrl: '../addons/lexiangpingou/web/resource/js/app',
	paths: {
		...
		'order' : './order.min',
		'util' : './util',
		'echarts':'../echarts/build/dist/echarts'
		//
...
//		'wapeditor' : 'wapeditor.min'
	...
	shim:{
		...
		'select2': {
			deps: ['css!../../components/select2/select2.min.css', '../addons/lexiangpingou/web/resource/components/select2/select2.min.js']
		},
		'clockpicker': {
			exports: "$",
